            ...
            <div class="col-md-offset-3 col-md-6">
                ...
                <form class="form" id="form1" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RangeValidator CssClass="alert alert-danger" ID="AgeRangeValidator" runat="server" ErrorMessage="Please enter a valid Age between 1-130" MinimumValue="1" MaximumValue="130" Type="Integer" ControlToValidate="AgeTextBox"></asp:RangeValidator>
                    </div>
